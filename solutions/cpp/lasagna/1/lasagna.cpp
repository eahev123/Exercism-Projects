...
int remainingOvenTime(int actualMinutesInOven) {
    ...
    int neededBakeTime = ovenTime();
    int expected{neededBakeTime - actualMinutesInOven};
    return expected;
}
...
int elapsedTime(int numberOfLayers, int actualMinutesInOven) {
    ...
    int workedOnCooking = 2 * numberOfLayers + actualMinutesInOven;
    return workedOnCooking;
}
